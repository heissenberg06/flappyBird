...
class Column(pygame.sprite.Sprite):
    def __init__(self, *groups):
        self._layer = Layer.OBSTACLE #because each columns are one of the obstacles
        self.gap = 100
        ...
        self.image = pygame.surface.Surface((self.sprite_rect.width, self.sprite_rect.height *2 + self.gap), pygame.SRCALPHA) #thanks to this line, background of the columns are naturel as if there is sky
